  ...
  render() {
    return (
        ...
        <Switch>
          ...
          <Route path="/jobOffer/:id" component={requireAuth(ManageJobOfferPage)} />
          <Route path="/jobOffer" component={requireAuth(ManageJobOfferPage)} />
          ...
          <Route path="/manageJobInsight" component={requireAuth(ManageJobInsight)} />
          <Route path="/manageJobLocation" component={requireAuth(ManageJobLocation)} />
