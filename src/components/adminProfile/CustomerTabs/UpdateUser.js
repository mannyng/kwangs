...
class UpdateUser extends React.Component {
  ...
  handleSubmit(e){
      //debugger;
      e.preventDefault();
      const {user_id,username,firstname,lastname,address,city,state,status,customer_type} = this.state;
      //const id = this.state.card.job.id;
      this.props.actions.adminCreateCustomer(user_id,username,firstname,lastname,address,city,state,status,customer_type);
  }
    ...
    return (
      <div>
        ...
        <Modal
          ...
          contentLabel="Add Customer to User"
        >

          <h2 ref={subtitle => this.subtitle = subtitle}>Add customer to this user</h2>
          <article>
              ...
              <div className="row">
               ...
               <div className="row">
                 ...
                 <select value={this.state.state} 
                  ...
                  {naijaStateList && naijaStateList.length >= 1 && naijaStateList.map(naija_stateOption =>
