...
renderField.propTypes = {
 ...
 const AddJobRequestForm = props => {
  const { handleSubmit, pristine, reset, submitting, submitJobRequest, jobCategories} = props;
  //debugger;
  return (
  <div>
       <h4>Employee Post Form</h4>
    <form onSubmit={handleSubmit(submitJobRequest)}>
      <Field
        name="employee_title" 
        type="text"
...
AddJobRequestForm.contextTypes = {
  router: PropTypes.object.isRequired
};
AddJobRequestForm.propTypes = {
...
export default reduxForm({
  form: 'addJobRequestForm', // a unique identifier for this form
  validate,
})(AddJobRequestForm);
