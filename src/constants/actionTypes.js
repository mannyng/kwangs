...
export const CREATE_MY_CAMPAIGN_SUCCESS = 'CREATE_MY_CAMPAIGN_SUCCESS';
export const UPDATE_MY_CAMPAIGN_SUCCESS = 'UPDATE_MY_CAMPAIGN_SUCCESS';
export const RETRIEVE_MOST_RECENT_OFFER_LIST_SUCCESS = 'RETRIEVE_MOST_RECENT_OFFER_LIST_SUCCESS';
export const ADMIN_CREATE_JOB_OFFER_SUCCESS = 'ADMIN_CREATE_JOB_OFFER_SUCCESS';
export const ADMIN_UPDATE_JOB_OFFER_SUCCESS = 'ADMIN_UPDATE_JOB_OFFER_SUCCESS';
export const ADMIN_UPDATE_OFFER_INSIGHT_SUCCESS = 'ADMIN_UPDATE_OFFER_INSIGHT_SUCCESS';
export const ADMIN_UPDATE_OFFER_LOCATION_SUCCESS = 'ADMIN_UPDATE_OFFER_LOCATION_SUCCESS';
export const ADMIN_RETRIEVE_ALL_CUSTOMERS_SUCCESS = 'ADMIN_RETRIEVE_ALL_CUSTOMERS_SUCCESS';
export const ADMIN_RETRIEVE_ALL_USERS_SUCCESS = 'ADMIN_RETRIEVE_ALL_USERS_SUCCESS';
export const ADMIN_CREATE_CUSTOMER_SUCCESS = 'ADMIN_CREATE_CUSTOMER_SUCCESS';
export const ADMIN_RETRIEVE_RECENT_REQUESTS_SUCCESS = 'ADMIN_RETRIEVE_RECENT_REQUESTS_SUCCESS';
export const ADMIN_UPDATE_OFFER_REQUEST_SUCCESS = 'ADMIN_UPDATE_OFFER_REQUEST_SUCCESS';
