...
import  MyAdminTab from '../components/customerProfile/MyAdminTab';
...
export class CustomerProfile extends React.Component {
  constructor(props, context) {
   ...
   shouldComponentUpdate(nextProps) {
    // debugger;
        ...
        return differentUser  || differenConnect || differenProfile || differenModalStatus;// || differenJobsLength
    }
  ...
  render() {
    //debugger;
    const {profile, customerConnect, actions, currentUser, myCampaigns, isOpen} = this.props;
    //debugger;
    return (
        ...
        <Main>
          ...
          {profile.myprofile.id &&
           <MyAdminTab actions={actions} customerConnect={customerConnect}
            currentUser={currentUser} myCampaigns={myCampaigns} isOpen={isOpen} profile={profile} />
          }
          </div>  
          <Footers>
           <Footer/>
...
CustomerProfile.propTypes = {
  ...
  myCampaigns: PropTypes.array.isRequired,
