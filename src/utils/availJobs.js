...
export function calculateAvailJobsPerMonth(settings) {
...
export function calculateAvailJobs(settings) {
  const monthlySavings = calculateAvailJobsPerMonth(settings);
