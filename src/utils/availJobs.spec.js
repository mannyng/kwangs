import {necessaryDataIsProvidedToCalculateSavings, calculateMilesDrivenPerMonth, calculateAvailJobsPerMonth} from './availJobs';

describe('Available Jobs Calculator', () => {
  ...
  describe('calculateSavingsPerMonth', () => {
    it('returns 29.93 in savings per month with these settings', () => {
      ...
      // act
      const savingsPerMonth = calculateAvailJobsPerMonth(settings);
